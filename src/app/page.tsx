...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 relative">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section
          aria-label="Profile and Empire State Images"
        ...
        <div
          className="bg-white/70 shadow-xl rounded-2xl overflow-hidden backdrop-blur-lg border border-white/20 relative"
          style={{
          ...
          <div className="px-6 py-8 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-indigo-50">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={handleClose}
                  className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#8952fc] rounded-lg shadow-lg focus-visible:outline-2 focus-visible:outline-violet-400 focus-visible:outline-offset-2"
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-lg focus-visible:outline-2 focus-visible:outline-blue-400 focus-visible:outline-offset-2"
  ...
  {/* CancelFlowModal for cancel subscription */}
  <CancelFlowModal open={modalOpen} onClose={() => setModalOpen(false)} userId={mockUser.id} />
            </div>
          </div>
